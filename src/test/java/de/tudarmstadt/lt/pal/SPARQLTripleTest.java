...
public class SPARQLTripleTest extends TestCase {
	...
	public void testEquals() {
		...
		Element p1 = new Constant("starringIn");
		Element o1 = new Constant("Mission Impossible");
		Triple t1 = new Triple(s1, p1, o1);
		
		Element s2 = new Variable("a", Variable.Type.Unknown);
		Element p2 = new Constant("starringIn");
		Element o2 = new Constant("Mission Impossible");
